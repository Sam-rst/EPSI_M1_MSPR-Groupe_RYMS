# Volumetrie et Performance

> **OBSOLETE** : Ce document decrit le schema v2.0 (5 tables). Le schema actuel est v3.0 (17 tables, ~17 262 lignes).
> Voir [Dictionnaire de Donnees v3.0](03-dictionnaire-donnees.md) pour la volumetrie a jour.
