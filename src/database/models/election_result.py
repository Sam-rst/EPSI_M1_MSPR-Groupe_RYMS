...
class ElectionResult(Base):
    ...
    nombre_inscrits = Column(Integer, nullable=False, comment="Nombre d'inscrits")
    nombre_votants = Column(Integer, nullable=False, comment="Nombre de votants")
    nombre_exprimes = Column(Integer, nullable=False, comment="Nombre de voix exprimées")
    taux_participation = Column(Numeric(5, 2), nullable=False, comment="% participation")
